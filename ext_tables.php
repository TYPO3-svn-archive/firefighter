...
$TCA["tx_firefighter_accidents"] = array (
	...
	"feInterface" => array (
		"fe_admin_fieldList" => "sys_language_uid, l18n_parent, l18n_diffsource, hidden, title, location, description, date, cars, type, lat, lng, rgcat",
	)
);
...
$TCA["tx_firefighter_cars"] = array (
	...
	"feInterface" => array (
		"fe_admin_fieldList" => "sys_language_uid, l18n_parent, l18n_diffsource, hidden, radioname, fullname, link, image",
	)
);
